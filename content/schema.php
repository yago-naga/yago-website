...
<details style='margin-left: 2em'><summary style='margin-left: -2em'>Incoming properties</summary><ul style='list-style-type: none'>
<li>- (yago:Creator) yago:notableWork<li>- (yago:FictionalEntity) yago:appearsIn<li>- (schema:MusicGroup) yago:notableWork</ul></details><details style='margin-left: 2em'><summary style='margin-left: -2em'>Subclasses</summary><ul style='list-style-type: none'>
...
<details style='margin-left: 2em'><summary style='margin-left: -2em'>Incoming properties</summary><ul style='list-style-type: none'>
<li>- (schema:Country) schema:officialLanguage<li>- (schema:CreativeWork) schema:inLanguage<li>- (schema:Person) schema:knowsLanguage</ul></details><details style='margin-left: 2em'><summary style='margin-left: -2em'>Subclasses</summary><ul style='list-style-type: none'>
</ul></details></details>
...
<details style='margin-left: 2em'><summary style='margin-left: -2em'>Incoming properties</summary><ul style='list-style-type: none'>
<li>- (schema:AdministrativeArea) schema:memberOf<li>- (schema:Book) schema:publisher<li>- (schema:Movie) schema:productionCompany<li>- (schema:MusicGroup) schema:recordLabel<li>- (schema:Organization) schema:memberOf<li>- (schema:Organization) schema:memberOf<li>- (schema:Organization) schema:parentOrganization<li>- (schema:Person) schema:affiliation<li>- (schema:Person) schema:worksFor<li>- (schema:Person) schema:alumniOf<li>- (schema:Person) schema:memberOf<li>- (schema:TVSeries) schema:productionCompany</ul></details><details style='margin-left: 2em'><summary style='margin-left: -2em'>Subclasses</summary><ul style='list-style-type: none'>
...
<details style='margin-left: 2em'><summary style='margin-left: -2em'>Incoming properties</summary><ul style='list-style-type: none'>
<li>- (schema:Country) yago:capital</ul></details><details style='margin-left: 2em'><summary style='margin-left: -2em'>Subclasses</summary><ul style='list-style-type: none'>
</ul></details></details>
...
<details style='margin-left: 2em'><summary style='margin-left: -2em'>Incoming properties</summary><ul style='list-style-type: none'>
<li>- (schema:Movie) schema:countryOfOrigin<li>- (schema:Person) schema:nationality<li>- (schema:TVSeries) schema:countryOfOrigin</ul></details><details style='margin-left: 2em'><summary style='margin-left: -2em'>Subclasses</summary><ul style='list-style-type: none'>
</ul></details></details>
</ul></details></details>
